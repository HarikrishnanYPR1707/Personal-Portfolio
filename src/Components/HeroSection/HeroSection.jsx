		...
		<section className="p-6 m-5 bg-[#282828] rounded-lg flex flex-col justify-center items-center md:w-5/6 md:mx-auto lg:w-5/6 lg:mx-auto lg:p-10 lg:flex-row lg:justify-evenly lg:items-center ">
			...
			<div className="mt-4 flex flex-col justify-center items-center lg:mt-0 lg:w-3/6">
				...
				<p className="text-center text-white text-sm font-robotoMono md:text-base lg:text-lg">
					React Developer | Frontend Developer | UI Designer | Content
					Creator | Student | Engineer
				</p>
				<div className="mt-4">
					<button className="mx-2 px-5 py-1 bg-[#a6f8db] rounded-lg xs:scale-90 xs:mx-0 xs:px-4 lg:hover:scale-110 lg:ease-in-out lg:duration-300">
						<a
							href="https://www.linkedin.com/in/harikrishnan-prasannakumar-b235a0236/"
							target="_blank"
						>
							<img
								src={linkedin}
					...
					<button className="mx-2 px-5 py-1 bg-[#a6f8db] rounded-lg xs:scale-90 xs:mx-0 xs:px-4 lg:hover:scale-110 lg:ease-in-out lg:duration-300">
						<a
							href="https://www.instagram.com/_coding_adda/"
							target="_blank"
						>
							<img
								src={instagram}
					...
					<button className="mx-2 px-5 py-1 bg-[#a6f8db] rounded-lg xs:scale-90 xs:mx-0 xs:px-4 lg:hover:scale-110 lg:ease-in-out lg:duration-300">
						<a
							href="https://www.youtube.com/@coding_adda"
							target="_blank"
						>
					...
					<button className="mx-2 px-5 py-1 bg-[#a6f8db] rounded-lg xs:scale-90 xs:mx-0 xs:px-4 lg:hover:scale-110 lg:ease-in-out lg:duration-300">
						<a
							href="https://github.com/HarikrishnanYPR1707"
							target="_blank"
						>
