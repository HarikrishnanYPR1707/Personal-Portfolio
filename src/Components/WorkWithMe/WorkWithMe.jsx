			...
			<div className="flex flex-col justify-center items-center lg:flex-row lg:gap-[100px]">
				<div className="">
					<img
						src={workWithMeSvg}
						alt="workWithMeSvg"
						className="w-72 mt-5 mb-5 md:w-[500px] lg:w-[450px]"
					/>
				</div>
				<div className="flex flex-col justify-center items-center">
					<input
						type="text"
						id="input-1"
						className="bg-[#282828] text-white w-[350px] py-2 pl-5 mb-5 rounded-lg border-b-2 border-[#a6f8db] outline-none xs:w-[300px] md:w-[500px] lg:w-[350px]"
					...
					<input
						type="submit"
						className="px-10 py-2 font-bold bg-[#a6f8db] rounded-md md:px-[100px]"
						onClick={submitInfo}
					/>
				</div>
			</div>
